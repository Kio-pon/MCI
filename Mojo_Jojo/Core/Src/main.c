...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, RMOTOR_IN1_Pin|RMOTOR_IN2_Pin|LMOTOR_IN1_Pin|LMOTOR_IN2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RMOTOR_IN1_Pin RMOTOR_IN2_Pin LMOTOR_IN1_Pin LMOTOR_IN2_Pin */
  GPIO_InitStruct.Pin = RMOTOR_IN1_Pin|RMOTOR_IN2_Pin|LMOTOR_IN1_Pin|LMOTOR_IN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
